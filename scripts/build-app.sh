...
swift build -c release --product bookmarkedctl
...
cp "$BINARY_PATH/bookmarkedctl" "$APP_DIR/Contents/MacOS/bookmarkedctl"
...
echo "built: $APP_DIR"
echo "built: $BINARY_PATH/bookmarkedctl (installs as 'bookmarked')"
